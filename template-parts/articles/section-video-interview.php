                    ...
                    while ($query_top_videos->have_posts()) : $query_top_videos->the_post();
                        ...
                        <div class="video-wrapper">
                            ...
                            <?php if ($video_details) : ?>
                                <h3><?php echo esc_html($video_details['title']); ?></h3>
                    ...
                    while ($query_tv_interviews->have_posts()) : $query_tv_interviews->the_post();
                        ...
                        <div class="video-wrapper">
                            ...
                            <?php if ($video_details) :
                              ...
                              <video src="<?php echo esc_url($video_url); ?>" autoplay controls=false poster="<?php echo esc_url(get_the_post_thumbnail_url( get_the_ID(), 'medium' )); ?>">
